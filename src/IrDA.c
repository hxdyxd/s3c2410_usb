...
/*	
	...
	puts("1)9600    2)19200    3)38400    4)57600    5)115200\r\n");
	...
	IrDA_BAUD = 19200;
	printf("Select baudrate = %d\r\n", IrDA_BAUD);
	
	rUBRDIV2 = ((int)(SYS_PCLK/16./IrDA_BAUD)-1);
	//printf("rUBRDIV2 = %d\r\n", rUBRDIV2);
	...
	//Use PCLK,Tx&RxLevel interrupt,Rx timeout disable,Rx err interrupt enable,Non-loopback,Tx&Rx disable
	puts("Now start UART IrDA Tx&Rx test, check data[a~z]\r\n");
