...
//	MMU_SetMTT(0x00000000,0x07f00000,0x00000000,RW_NCNB);  //bank0
	MMU_SetMTT(0x00000000,0x00400000,0x30100000,RW_CB);  //bank0  when no nor flash, must do this
...
//    MMU_SetMTT(0x30200000,0x33e00000,0x30200000,(AP_RO|DOMAIN0|NCNB|DESC_SEC)); //bank6-2		原来的
    MMU_SetMTT(0x31000000,0x33e00000,0x31000000,RW_CB); //bank6-2		龚俊修改的
    MMU_SetMTT(0x33f00000,0x33f00000,0x33f00000,RW_CB);   //bank6-3		原来的
